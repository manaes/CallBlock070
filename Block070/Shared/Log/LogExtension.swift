...
public class Log: NSObject {
    ...
    static public func log(_ message: Any, level: Level) {
#if DEBUG
...
extension Log {
     ...
     */
    static public func network(_ message: Any) {
    ...
    /**
     ...
     - Note : 트큰 로직 관련 로그
     */
    static public func token(_ message: Any) {
    ...
    /**
     ...
     - Note : 커스텀 디버깅 로그
     */
    static public func custom(category: String, _ message: Any) {
